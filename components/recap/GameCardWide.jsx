...
import { Clock, Trophy, TrendingUp, Calendar, ArrowLeft } from "lucide-react";
...
export default function GameCardWide({ game, onClick, featured = false, showDate = false }) {
  ...
  if (featured) {
    return (
      <div className="relative p-[2px] rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-gradient-rotate animate-glow-pulse">
        <div className="relative bg-white rounded-xl">{cardContent}</div>
      </div>
    );
  }
